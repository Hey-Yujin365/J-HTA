...
-- 조인 방식
SELECT D.DEPARTMENT_ID, M.FIRST_NAME, C.CNT, C.AVG
FROM DEPARTMENTS D, EMPLOYEES M,
     (SELECT DEPARTMENT_ID, COUNT(*) CNT, TRUNC(AVG(SALARY)) AVG
      FROM EMPLOYEES E
...
SELECT M.EMPLOYEE_ID, M.FIRST_NAME, C.CNT, D.DEPARTMENT_NAME
FROM EMPLOYEES M,
