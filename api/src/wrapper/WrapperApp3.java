...
public class WrapperApp3 {
	...
	public static void main(String[] args) {
		 ...
		 * 	- Wrapper 클래스의 정적 메소드를 활용하면 문자열을 숫자로 반환할 수 있다.
		 * 
		 ...
		 * 
		 * 숫자를 문자열로 변환하기
		 * 	- String 클래스의 정적 메소드를 활용하면 숫자를 문자열로 변환할 수 있다.
		 * 
		...
		long b = Long.parseLong("10000000000000");
		double c = Double.parseDouble("3.141592");
		
//		int d = Integer.parseInt("1234   ".trim());	// NumberFormatException 예외 발생
...
//		System.out.println(d);
		 ...
		 * Object x = 10;
		 * 
		 * x가 Object 타입의 참조변수기 때문에 Integer 객체가 생성됨 - 오토박싱
		 * 			= new Integer(10);
		 * 
