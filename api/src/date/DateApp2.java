...
public class DateApp2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(text7);		// 03:33:09
		
		sdf.applyPattern("a h시 m분 s초");
		String text8 = sdf.format(now);
		System.out.println(text8);		// 오후 3시 33분 9초
		
		sdf.applyPattern("yyyy-MM-dd HH:mm:ss");
		String text9 = sdf.format(now);
		System.out.println(text9);		// 2023-11-15 15:33:09
		
		// DateUtils을 만들고 사용하기
		String text = DateUtils.dateToString(now);
		System.out.println(text);
		
		String text10 = DateUtils.dateToDetailString(now);
