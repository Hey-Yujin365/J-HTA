...
CREATE TABLE REQUESTS (
    ...
    CONSTRAINT REQ_STUDNO_COURSENO_KF PRIMARY KEY (STUD_NO, COURSE_NO),
...
-- 과정번호, 과정명, 개설학과, 담당교수, 신청일 조회하기
-- 신청정보                 과정정보                            학과정보             교수정보
-- [학번,*과정번호,신청일]-[*과정번호,과정명,+학과번호,&교수번호]-[+학과번호,학과명]-[&교수번호,교수명]
SELECT R.COURSE_NO, C.COURSE_NAME, D.DEPT_NAME, P.PROF_NAME, R.REQ_DATE
...
-- 테이블 삭제하기
DROP TABLE DEPTS;           -- PROFESSORS, STUDENTS, COURSES 에서 참조하고 있다.
