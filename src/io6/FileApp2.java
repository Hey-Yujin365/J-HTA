...
public class FileApp2 {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * 
		 * 	+ 현재 존재하지 않는 파일이나 디렉토리에 대해서도 File객체를 생성할 수 있다
		 * 	+ createNewFile() 메소드는 사이즈가 0인 파일을 생성한다.
		 * 	+ mkdir() 메소드는 디렉토리를 생성한다.
		 * 	+ mkdirs() 메소드는 한번에 하위 디렉토리까지 포함시켜서 생성한다.
		...
		// 디렉토리 삭제하기
		dir2.delete();	// src/io6/app2/sample/files 경로에서 files가 삭제되고,
						// src/io6/app2/sample가 남았다.
