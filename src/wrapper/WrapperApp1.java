...
public class WrapperApp1 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 오토박싱
		 * 	- 기본자료형값을 Wrapper 클래스타입의 변수에 저장시키면
		...
		Long wrapper4 = 1000000000000L;
		Float wrapper5 = 3.14f;
		Double wrapeer6 = 3.14;
		 ...
		 * }
		 */
		System.out.println(wrapper1);	// "1", 이것은 숫자1이 아니라 문자 1이다
		System.out.println(wrapper2);	// "1", toString() 메소드가 반환하는 값이 출력되기 때문이다.
