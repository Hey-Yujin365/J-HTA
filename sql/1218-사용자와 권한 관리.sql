...
롤(Role)
    ...
    대표적인 롤
        ...
        DBA 롤
            데이터베이스를 관리하는 시스템권한을 대부분 포함하고 있는 롤이다.
...
/*
CREATE TABLE        자신 소유의 테이블을 생성하는 시스템 권한, 일반사용자한테 필요한 것
CREATE ANY TABLE    임의의 소유 테이블을 생성하는 시스템 권한, 관리자한테 필요한 것
*/
