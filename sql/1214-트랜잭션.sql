...
트랜잭션
    ...
    예) 홍길동이 이순신에게 100만원을 이체한다.
        ...
        + 논리적인 작업의 단위(그룹, 묶음, 연산들) = 감소 UPDATE작업 + 증가 UPDATE작업 + 추가 INSERT작업
    ...
    트랜잭션의 시작과 종료
        트랜잭션의 시작
            - 첫 번째 DML 명령문이 실행될 때 새로운 트랜잭션이 시작된다.
...
UPDATE ACCOUNTS
SET
    DEPOSIT = DEPOSIT + 50000       // 트랜잭션2의 연산이다.
WHERE
    NO = 120;
    
INSERT INTO HISTORIES
VALUES (70, 120, 50000, SYSDATE);   // 트랜잭션1의 연산이다.

ROLLBACK;                           // 트랜잭션2의 INSERT 작업 중 오류가 발생하였다.
