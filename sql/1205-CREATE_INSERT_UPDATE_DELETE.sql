...
/*
    ...
    DEFAULT SYSDATE
        새로운 행을 추가할 때 해당 컬럼에 값을 지정하지 않으면 시스템의 현재 날짜가 지정된다.
*/
...
/*
    ...
    VALUES              (값,    값,    값);
    * 신규 해을 추가할 때 값이 저장될 컬럼을 직접 나열하는 방식이다.
...
INSERT INTO sample_books
VALUES(16, '쇼코의 미소', '최은영', 9900, 10, SYSDATE);
...
-- 아래와 같은 조건을 잘 사용하지 않는다. 보통 기본키값을 이용한다.
